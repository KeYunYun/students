package com.example.kcy.webpictureview;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //1.找到相应控件
         ...
         tv_look= (ImageView) findViewById(R.id.im_look);
                    ...
                    try {
                        ...
                        if(code == 200){
                           ...
                           // Message message =new Message();
                            Message message=Message.obtain();//获取一个Message对象，如果可以复用之前
                                                                            // 的，如果以前有直接使用，没有才创建
                            //将获得的数据封装到message中
                            message.obj=bitmap;
